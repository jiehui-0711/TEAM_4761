...
public class runa1 {
    ...
    public static void main(String args[]) throws IOException {
        ...
        for (file_ind = 0; file_ind < datalen; file_ind++) {
            ...
            words = 0;
            ls = 0;
            inp_path = "data3/" + Integer.toString(file_ind) + ".txt";
            try (BufferedReader br = new BufferedReader(new FileReader(inp_path, StandardCharsets.UTF_8))) {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    //--------organization---------
                    s = organization(line, Integer.toString(file_ind));
                    if (!s.equals("nono")) {
                        dus1.add(s + "\n");
                    }
                    //--------patoent-----------
        ...
        for (file_ind = 0; file_ind < fdatalen; file_ind++) {
            ...
            words = 0;
            ls = 0;
            inp_path = "data3/" + "HSA0" + Integer.toString(file_ind) + ".txt";
            try (BufferedReader br = new BufferedReader(new FileReader(inp_path, StandardCharsets.UTF_8))) {
                String line;
                ArrayList<String> ss;
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    //--------organization---------
                    s = organization(line, "HSA0" + Integer.toString(file_ind));
                    if (!s.equals("nono")) {
                        dus1.add(s + "\n");
                    }
                    //----------patient--------
    ...
    public static String duration(String n, String file) {
        ...
        char n1[] = n.toCharArray();
        String sp[] = {"month", "months", "year", "yr", "yrs", "years", "week", "weeks", "wks", "wk", "days", "day"};
        for (String i : sp) {
            if (n.contains(i)) {
    ...
    public static String phone(String n) {
        ...
        for (int i = 0; i < n.length() - 10; i++) {
            ...
            if (bo) {
                return get_ans(n.substring(i + 1, i + 9), i + 1, "PHONE");
            }
        }
        return "nono";
    }
